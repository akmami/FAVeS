...
#define __blend_get_kmer(kmer) 			((kmer).x >> 14)
#define __blend_get_length(kmer) 		((kmer).x & 0x3FFF)
#define __blend_get_reference_id(kmer) 	(((kmer).y >> 32))
#define __blend_get_index(kmer) 		(((kmer).y & 0xFFFFFFFF) >> 1)
#define __blend_get_strand(kmer) 		(((kmer).y & 1))
